 ...
 * @author L
 */
public class m_formCustomer extends m_super {

    Connection con;

    public m_formCustomer() {
        con = new m_koneksi().connection();
    }

    public void tambahPonsel(String Nama, String Alamat, String Notelp, String Pekerjaan, String NoKTP, String PKredit) {
        String query = "insert into customer "
                + "VALUES (NULL, '" + Nama + "', '" + Alamat + "','" + Notelp + "','" + Pekerjaan + "','" + NoKTP + "','" + PKredit + "')";
        Statement stmt = null;
        try {
    ...
    public DefaultTableModel ReadData() {
        ...
        Statement stmt = null;
        String query = "SELECT idBarang,merkBarang FROM produkkredit";
        try {
            stmt = con.createStatement();
