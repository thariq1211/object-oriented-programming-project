 ...
 * @author L
 */
public class m_angsuranDept extends m_super {

    Connection con;

    public m_angsuranDept() {
    ...
    public void UpdateData(String NoPenjualan, String Subsidi, String bunga, String totalKredit, int id) {
        String query = "UPDATE angsuran SET noPenjualan='" + NoPenjualan + "',subsidi='"
                + Subsidi + "',bunga='" + bunga + "',totalKredit='" + totalKredit + "' WHERE idAngsuran =" + id + "";
        Statement stmt = null;
        try {
            stmt = con.createStatement();
            stmt.execute(query);
