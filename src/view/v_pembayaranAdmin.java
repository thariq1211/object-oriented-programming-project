 ...
 * @author L
 */
public class v_pembayaranAdmin extends javax.swing.JFrame {

    /**
     * Creates new form v_pembayaranAdmin
     */
    public v_pembayaranAdmin() {
        initComponents();
        setUndecorated(true);
    }
    ...
    private void initComponents() {
        ...
        txtSisaKredit.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_pembayaranAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_pembayaranAdmin().setVisible(true);
            }
        });
    }
